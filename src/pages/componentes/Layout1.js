...
const NavigationBar = (props) => {
  ...
  const listItems = [
    { text: "Inicio", icon: <HomeIcon />, href: "/AlumnoPrincipal" },
    { text: "Perfil", icon: <PersonIcon />, href: "/AlumnoDatosPersonales" },
    { text: "Bibliotecas", icon: <LibraryBooksIcon />, href: "/AlumnoResultados" },
  ];
