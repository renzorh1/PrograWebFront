...
const Index = () => {
  ...
  const handleGuardarJSON = async (e) => {
    ...
    try {
      const response = await fetch("/api/Libro/EditarLibro", {
        method: "POST",
      ...
      <Layout content={
        <div className="dos-columnnas">
          <div className="columnna">
            <h1 className="titulo">Editar Libro</h1>
            <p className="divisor"></p>
        
            <div className="cuadro_principal">
              <a className="barra barra_texto_especial barra_contenido_especial">EDITAR LIBRO</a>
              ...
              <div className="formulario">
                ...
                <br />
                <button className="boton_guardar3" onClick={handleGuardarJSON}>Guardar Cambios</button>
              </div>
            </div>
          </div>
        </div>
