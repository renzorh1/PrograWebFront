          ...
          <div className="columnna">
            ...
            <div className="cuadro_principal">
              <div className="barra_horizontal">
                <li className="barra barra_navegacion barra_contenido_especial"><a href="/AdminDatosPersonales">Datos Personales</a></li>
                <li className="barra barra_navegacion barra_contenido_normal"><a href="/AdminCuenta">Cuenta</a></li>
              </div>
...
export default AdminDatosPersonales;
