...
const AlumnoCuenta = () => {
  ...
  return (
    <Layout content={
      <>
        <Head>
          <title>Alumno Buscar Cuenta</title>
        </Head>
          ...
          <div className="columnna">
            ...
            <div className="cuadro_principal">
              <div className="barra_horizontal">
                <li className="barra barra_navegacion barra_contenido_normal"><a href="/AlumnoDatosPersonales">Datos Personales</a></li>
                <li className="barra barra_navegacion barra_contenido_especial"><a href="/AlumnoCuenta">Cuenta</a></li>
              </div>
